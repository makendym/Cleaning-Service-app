...
const customTheme = createTheme({
  ...
  components: {
    ...
    MuiIconButton: {
      styleOverrides: {
        root: {
          color: focusedColor, // Default color for all icon buttons
          "&:hover": {
            backgroundColor: "rgba(140, 82, 255, 0.1)", // Custom hover background color
            color: focusedColor, // Maintain focus color on hover
          },
          "&:focus": {
            outline: "none",
            boxShadow: "0 0 0 2px rgba(140, 82, 255, 0.5)", // Custom focus boxShadow
          },
          "&:focus-visible": {
            outline: "none",
            boxShadow: "0 0 0 2px rgba(140, 82, 255, 0.5)", // Focus visible for keyboard navigation
          },
        },
      },
    },
